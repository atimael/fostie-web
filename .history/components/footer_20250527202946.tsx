  ...
  return (
    <footer className="py-6 px-6 flex items-center justify-center">
      <div className="flex items-center justify-between">
        <a
          className="group inline-flex items-center outline-none transition duration-300 hover:bg-stone-800/5 focus:ring-2 focus:ring-pink-300 dark:bg-orange-50/5 dark:hover:bg-orange-50/5 rounded-xl bg-stone-800/5 p-2 text-stone-500 hover:text-stone-800 dark:text-orange-50 dark:hover:text-orange-50"
