export default function Footer() {
  ...
  return (
    <footer className="py-6 px-6 flex items-center relative flex-col justify-center">
      ...
      <div className="pointer-events-none motion-preset-blur-down motion-delay-1750 -mt-6 hidden select-none overflow-hidden bg-gradient-to-b from-25% bg-clip-text text-[14rem] font-black leading-none text-transparent sm:block sm:h-36 md:h-48 md:text-[18rem] lg:h-60 lg:text-[22rem] from-orange-50/20 to-orange-50/0">
        Fostie
      </div>
    </footer>
  );
