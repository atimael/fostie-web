  ...
  return (
    <section className="flex w-full max-w-screen-xl flex-col items-center">
      ...
      >
        ...
        <AppstoreButton className={"motion-delay-600 flex pt-8 sm:hidden"} />
      </section>

      <section className="motion-preset-blur-up motion-delay-1000 mb-64 w-full flex-col items-center sm:mb-64 sm:flex md:mb-72 lg:mb-24">
        <div className="relative aspect-[1.95/1] h-full w-full">
          ...
          {timerShow && (
            <TimerContent
              className="absolute top-[-2.5rem] left-2/4 z-30 -translate-x-2/4 scale-50 sm:top-[1.5rem] sm:-right-[1.5rem] sm:left-[unset] sm:translate-0 sm:scale-75 md:top-[6rem] md:scale-100"
              style={{
                transform: `translateY(${parallax / 30}px)`,
              }}
            />
